...
# ==================== CONFIGURACIÓN ====================
data_dir = 'dataArmas'
output_root = os.path.join('', 'SinGrafica')
os.makedirs(output_root, exist_ok=True)

annotations_path = os.path.join(output_root, 'anotaciones_mejoradas.csv')
...
if csv_rows:
    ...
    if imagenes_sin_detecciones:
        reporte_path = os.path.join(output_root, 'imagenes_sin_detecciones_nuevo.txt')
